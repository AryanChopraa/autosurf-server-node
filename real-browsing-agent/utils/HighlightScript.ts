...
//     document.querySelectorAll(removeHighlightSelector).forEach((element) => {
...
export const HIGHLIGHT_ELEMENTS_SCRIPT = `
    ...
    var selector = 'a, button, div[onclick], div[role="button"], div[tabindex], span[onclick], span[role="button"], span[tabindex]';
